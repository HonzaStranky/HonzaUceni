...
const Stats = (() => {
    ...
    function renderSubjectChart() {
        ...
        const nameMap = { 
            en: 'Angličtina', math: 'Matematika', czech: 'Čeština', 
            civics: 'Občanská výchova', nature: 'Přírodopis', 
            geography: 'Zeměpis', history: 'Dějepis', teacher: 'Vlastní' 
        };
        const colorMap = { 
            en: '#00B4D8', math: '#6C63FF', czech: '#FF6584', 
            civics: '#F59E0B', nature: '#10B981', 
            geography: '#8B5CF6', history: '#EC4899', teacher: '#9CA3AF' 
        };
